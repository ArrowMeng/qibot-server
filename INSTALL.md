...
- Fetch, build tinode server and tinode-db database initializer:
 - `go get github.com/ArrowMeng/qibot-server/server && go install github.com/ArrowMeng/qibot-server/server`
 - `go get github.com/ArrowMeng/qibot-server/tinode-db && go install github.com/ArrowMeng/qibot-server/tinode-db`
...
- Run DB initializer
 `$GOPATH/bin/tinode-db -config=$GOPATH/src/github.com/ArrowMeng/qibot-server/server/tinode.conf`
 - add `-data=$GOPATH/src/github.com/ArrowMeng/qibot-server/tinode-db/data.json` flag if you want sample data to be loaded.
...
- Run server `$GOPATH/bin/server -config=$GOPATH/src/github.com/ArrowMeng/qibot-server/server/tinode.conf -static_data=$HOME/tinode/example-react-js/`
