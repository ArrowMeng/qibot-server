...
import (
	...
	_ "github.com/ArrowMeng/qibot-server/push_fcm"
	_ "github.com/ArrowMeng/qibot-server/server/auth_basic"
	_ "github.com/ArrowMeng/qibot-server/server/db/rethinkdb"
	"github.com/ArrowMeng/qibot-server/server/push"
	_ "github.com/ArrowMeng/qibot-server/server/push_stdout"
	"github.com/ArrowMeng/qibot-server/server/store"
	"github.com/ArrowMeng/qibot-server/server/store/types"
)
